...
- **Nyaa Group Hider**
  Hides torrent rows on `https://nyaa.si/` when the release title starts with a configured group tag such as `[SubsPlease]`. Hidden groups can be edited from Tampermonkey’s userscript menu without changing the script.
